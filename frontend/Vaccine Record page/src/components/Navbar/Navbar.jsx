...
const Navbar = ({ setShowLogin }) => {
    ...
    return (
        <div className="w-full bg-blue-900 text-white fixed top-0 left-0 z-50"> {/* Added fixed, top, left, z-50 */}
            <div className="flex justify-between items-center p-4">
                <div className="flex items-center">
                    <img src='logo.png' alt="Health Guardian Logo" className="h-10 mr-2" />
                    <span className="text-2xl font-bold">Health Guardian</span>
                </div>
